...
dataset = pd.read_csv("C:/Users/yrakotch/Desktop/tmp/MasterDegree/LemidaHishuvit/exercise1/regression_datasets/3D_Road_Network/3D_spatial_network_partial.csv")
target_col = 'ALTITUDE'
